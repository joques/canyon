...
\fl{}\moduleLeftDash\cl{ {\MODULE} Replicas}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{ {\ASSUME}}
\fl{ \.{\land}}\al{32}{1}{ MaxOffset \.{>} 0}
\fl{ \.{\land}}\al{33}{1}{ Leader \.{\in} Replicas}
\fl{}
\fl{ {\VARIABLES}}
\fl{ controllerState ,\,}
\fl{ leaderState ,\,}
...
\fl{ updates}
\fl{}
\fl{ Offsets \.{\defeq} 0 \.{\dotdot} MaxOffset}
\fl{ Nil \.{\defeq} \.{-} 1}
\fl{}
\fl{ LeaderState \.{\defeq} [}
\fl{ isr \.{:} {\SUBSET} Replicas ,\,}
\fl{ version \.{:} Nat ,\,}
\fl{ pendingIsr \.{:} {\SUBSET} Replicas ,\,}
\fl{ pendingVersion \.{:} Nat ,\,}
\fl{ offsets \.{:} [ Replicas \.{\rightarrow} Nat ]}
\fl{ ]}
\fl{}
\fl{ ControllerState \.{\defeq} [}
\fl{ isr \.{:} {\SUBSET} Replicas ,\,}
\fl{ version \.{:} Nat}
\fl{ ]}
\fl{}
...
\fl{ ]}
\fl{}
\fl{ HighWatermark \.{\defeq}}
 \fl{ \.{\LET}}\al{63}{1}{ potentialIsr \.{\defeq} leaderState . isr \.{\cup}
 leaderState . pendingIsr}
 \fl{ \.{\IN}}\al{64}{1}{ Min ( \{ leaderState . offsets [ replica ] \.{:}
 replica \.{\in} potentialIsr \} )}
\fl{}
\fl{ TypeOk}\al{66}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{67}{1}{ controllerState \.{\in} ControllerState}
\fl{ \.{\land}}\al{68}{1}{ leaderState \.{\in} LeaderState}
\fl{ \.{\land}}\al{69}{1}{ requests \.{\subseteq} Message}
\fl{ \.{\land}}\al{70}{1}{ updates \.{\subseteq} Message}
\fl{}
\fl{ ControllerWriteIsr ( isr ,\, version ) \.{\defeq}}
\fl{ \.{\land}}\al{73}{1}{ version \.{=} controllerState . version \.{+} 1}
 \fl{ \.{\land}}\al{74}{1}{ controllerState \.{'} \.{=} [ isr \.{\mapsto} isr
 ,\, version \.{\mapsto} version ]}
\fl{}
\fl{ ControllerShrinkIsr \.{\defeq} \E\, replica \.{\in} Replicas \.{:}}
\fl{ \.{\land}}\al{77}{1}{ replica}\al{77}{2}{ \.{\neq} Leader}
\fl{ \.{\land}}\al{78}{1}{ replica}\al{78}{2}{ \.{\in} controllerState . isr}
 \fl{ \.{\land}}\al{79}{1}{ \.{\LET}}\al{79}{2}{ version \.{\defeq}
 controllerState . version \.{+} 1}
\fl{ isr \.{\defeq} controllerState . isr \.{\,\backslash\,} \{ replica \}}
 \fl{ \.{\IN}}\al{81}{1}{ \.{\land}}\al{81}{2}{ ControllerWriteIsr ( isr ,\,
 version )}
 \fl{ \.{\land}}\al{82}{1}{ updates \.{'} \.{=} updates \.{\cup} \{ [ isr
 \.{\mapsto} isr ,\, version \.{\mapsto} version ] \}}
 \fl{ \.{\land}}\al{83}{1}{ {\UNCHANGED} {\langle} leaderState ,\, requests
 {\rangle}}
\fl{}
\fl{ ControllerHandleRequest \.{\defeq} \E\, message \.{\in} requests \.{:}}
\fl{ \.{\land}}\al{86}{1}{ message . version \.{=} controllerState . version}
 \fl{ \.{\land}}\al{87}{1}{ \.{\LET}}\al{87}{2}{ version \.{\defeq}
 controllerState . version \.{+} 1}
 \fl{ \.{\IN}}\al{88}{1}{ \.{\land}}\al{88}{2}{ ControllerWriteIsr ( message .
 isr ,\, version )}
 \fl{ \.{\land}}\al{89}{1}{ updates \.{'} \.{=} updates \.{\cup} \{ [ isr
 \.{\mapsto} message . isr ,\, version \.{\mapsto} version ] \}}
 \fl{ \.{\land}}\al{90}{1}{ {\UNCHANGED} {\langle} leaderState ,\, requests
 {\rangle}}
\fl{}
 \fl{ LeaderRequestShrinkIsr \.{\defeq} \E\, replica \.{\in} leaderState . isr
 \.{:}}
\fl{ \.{\land}}\al{93}{1}{ replica \.{\neq} Leader}
 \fl{ \.{\land}}\al{94}{1}{ \.{\LET}}\al{94}{2}{ isr \.{\defeq} leaderState .
 isr \.{\,\backslash\,} \{ replica \}}
\fl{ version \.{\defeq} leaderState . version}
 \fl{ \.{\IN}}\al{96}{1}{ \.{\land}}\al{96}{2}{ requests \.{'} \.{=} requests
 \.{\cup} \{ [}
\fl{ isr \.{\mapsto} isr ,\,}
\fl{ version \.{\mapsto} version}
\fl{ ] \}}
\fl{ \.{\land}}\al{100}{1}{ leaderState \.{'} \.{=} [ leaderState {\EXCEPT}}
\fl{ {\bang}}\al{101}{1}{ . pendingIsr \.{=} @ \.{\cup} isr ,\,}
\fl{ {\bang}}\al{102}{1}{ . pendingVersion \.{=} version}
\fl{ ]}
 \fl{ \.{\land}}\al{104}{1}{ {\UNCHANGED} {\langle} controllerState ,\,
 updates {\rangle}}
\fl{}
\fl{ LeaderRequestExpandIsr \.{\defeq} \E\, replica \.{\in} Replicas \.{:}}
\fl{ \.{\land}}\al{107}{1}{ replica \.{\notin} leaderState . isr}
 \fl{ \.{\land}}\al{108}{1}{ leaderState . offsets [ replica ] \.{\geq}
 HighWatermark}
 \fl{ \.{\land}}\al{109}{1}{ \.{\LET}}\al{109}{2}{ isr \.{\defeq} leaderState
 . isr \.{\cup} \{ replica \}}
\fl{ version \.{\defeq} leaderState . version}
 \fl{ \.{\IN}}\al{111}{1}{ \.{\land}}\al{111}{2}{ requests \.{'} \.{=}
 requests \.{\cup} \{ [}
\fl{ isr \.{\mapsto} isr ,\,}
\fl{ version \.{\mapsto} version}
\fl{ ] \}}
\fl{ \.{\land}}\al{115}{1}{ leaderState \.{'} \.{=} [ leaderState {\EXCEPT}}
\fl{ {\bang}}\al{116}{1}{ . pendingIsr \.{=} @ \.{\cup} isr ,\,}
\fl{ {\bang}}\al{117}{1}{ . pendingVersion \.{=} version}
\fl{ ]}
 \fl{ \.{\land}}\al{119}{1}{ {\UNCHANGED} {\langle} controllerState ,\,
 updates {\rangle}}
\fl{}
\fl{ LeaderWrite \.{\defeq}}
 \fl{ \.{\land}}\al{122}{1}{ leaderState \.{'} \.{=} [ leaderState {\EXCEPT}
 {\bang} . offsets [ Leader ] \.{=} @ \.{+} 1 ]}
 \fl{ \.{\land}}\al{123}{1}{ {\UNCHANGED} {\langle} controllerState ,\,
 requests ,\, updates {\rangle}}
\fl{}
\fl{ LeaderHandleUpdate \.{\defeq} \E\, update \.{\in} updates \.{:}}
\fl{ \.{\land}}\al{126}{1}{ update . version \.{>} leaderState . version}
\fl{ \.{\land}}\al{127}{1}{ leaderState \.{'} \.{=} [ leaderState {\EXCEPT}}
\fl{ {\bang}}\al{128}{1}{ . isr \.{=} update . isr ,\,}
\fl{ {\bang}}\al{129}{1}{ . version \.{=} update . version ,\,}
\fl{ {\bang}}\al{130}{1}{ . pendingIsr \.{=} \{ \} ,\,}
\fl{ {\bang}}\al{131}{1}{ . pendingVersion \.{=} Nil}
\fl{ ]}
 \fl{ \.{\land}}\al{133}{1}{ {\UNCHANGED} {\langle} controllerState ,\,
 requests ,\, updates {\rangle}}
\fl{}
\fl{ FollowerReplicate \.{\defeq} \E\, replica \.{\in} Replicas \.{:}}
\fl{ \.{\land}}\al{136}{1}{ replica \.{\neq} Leader}
 \fl{ \.{\land}}\al{137}{1}{ leaderState . offsets [ replica ] \.{<}
 leaderState . offsets [ Leader ]}
 \fl{ \.{\land}}\al{138}{1}{ leaderState \.{'} \.{=} [ leaderState {\EXCEPT}
 {\bang} . offsets [ replica ] \.{=} @ \.{+} 1 ]}
 \fl{ \.{\land}}\al{139}{1}{ {\UNCHANGED} {\langle} controllerState ,\,
 requests ,\, updates {\rangle}}
\fl{}
\fl{ Init \.{\defeq}}
\fl{ \.{\land}}\al{142}{1}{ controllerState \.{=} [}
\fl{ isr \.{\mapsto} Replicas ,\,}
\fl{ version \.{\mapsto} 0}
\fl{ ]}
\fl{ \.{\land}}\al{146}{1}{ leaderState \.{=} [}
\fl{ isr \.{\mapsto} Replicas ,\,}
\fl{ version \.{\mapsto} 0 ,\,}
\fl{ pendingIsr \.{\mapsto} \{ \} ,\,}
\fl{ pendingVersion \.{\mapsto} Nil ,\,}
\fl{ offsets \.{\mapsto} [ replica \.{\in} Replicas \.{\mapsto} 0 ]}
\fl{ ]}
\fl{ \.{\land}}\al{153}{1}{ requests \.{=} \{ \}}
\fl{ \.{\land}}\al{154}{1}{ updates \.{=} \{ \}}
\fl{}
\fl{ Next \.{\defeq}}
\fl{ \.{\lor}}\al{157}{1}{ ControllerShrinkIsr}
\fl{ \.{\lor}}\al{158}{1}{ ControllerHandleRequest}
\fl{ \.{\lor}}\al{159}{1}{ LeaderRequestShrinkIsr}
\fl{ \.{\lor}}\al{160}{1}{ LeaderRequestExpandIsr}
\fl{ \.{\lor}}\al{161}{1}{ LeaderWrite}
\fl{ \.{\lor}}\al{162}{1}{ LeaderHandleUpdate}
\fl{ \.{\lor}}\al{163}{1}{ FollowerReplicate}
\fl{}
 \fl{ ValidHighWatermark \.{\defeq} \A\, replica \.{\in} controllerState . isr
 \.{:}}
\fl{ leaderState . offsets [ replica ] \.{\geq} HighWatermark}
\fl{}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
