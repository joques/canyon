------------------------------ MODULE Replicas ------------------------------
(*
This is a Asynchronous Replication Module The we need to iuse to cahnge the write and update operations. 
We will only Replicate the acutal paths to save on disk space. 
*)
...
\* Last modified Fri Oct 28 11:46:59 CAST 2022 by goodwill
\* Created Fri Oct 28 11:13:25 CAST 2022 by goodwill
