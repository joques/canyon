...
\fl{}\moduleLeftDash\cl{ {\MODULE} StorageEngine}\moduleRightDash\cl{}
\fl{ {\EXTENDS} TLC ,\, Intergers ,\, Sequences ,\, Naturals}
\fl{}
\fl{ {\CONSTANTS}}
\fl{ MaxKeys ,\, Order}
\fl{}
...
\fl{}
\fl{}
\fl{ {\ASSUME} \.{\land} MaxKeys \.{\in} NAt \.{\,\backslash\,} \{ 0 \}}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ {\VARIABLES} values ,\, versions ,\, deleted ,\, keys}
\fl{}
 \fl{ TypeOK \.{\defeq}}\al{33}{2}{ \.{\land}}\al{33}{3}{ values \.{\in} [ 0
 \.{\dotdot} MaxKeys \.{-} 1 ]}
\fl{ \.{\land}}\al{34}{1}{ versions \.{\in} [ 0 \.{\dotdot} MaxKeys \.{-} 1 ]}
\fl{ \.{\land}}\al{35}{1}{ deleted \.{\in} [ 0 \.{\dotdot} MaxKeys \.{-} 1 ]}
\fl{ \.{\land}}\al{36}{1}{ keys \.{\in} [ 0 \.{\dotdot} MaxKeys \.{-} 1 ]}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{}
\fl{ TypeInvariant \.{\defeq}}
\fl{ \.{\land}}\al{44}{1}{ root \.{\in} BPlusTree}
\fl{ \.{\land}}\al{45}{1}{ keys [ i ] \.{\neq} keys [ j ] for all i ,\, j}
\fl{ \.{\land}}\al{46}{1}{ values [ i ] \.{\neq} values [ j ] for all i ,\, j}
\fl{ \.{\land}}\al{47}{1}{ keys [ i ] \.{\neq}\@w{deleted} for all i}
\fl{}
\fl{ Init \.{\defeq}}
\fl{ \.{\land}}\al{50}{1}{ root}\al{50}{2}{ \.{=}}\al{50}{3}{ emptyTree}
 \fl{ \.{\land}}\al{51}{1}{ keys}\al{51}{2}{ \.{=}}\al{51}{3}{ [ [\@w{deleted}
 ] \.{\mapsto} ( MaxKeys \.{-} 1 ) ]}
 \fl{ \.{\land}}\al{52}{1}{ values \.{=} [ [\@w{deleted} ] \.{\mapsto} (
 MaxKeys \.{-} 1 ) ]}
 \fl{ \.{\land}}\al{53}{1}{ versions \.{=} [ 0 \.{\mapsto} ( MaxKeys \.{-} 1 )
 ]}
 \fl{ \.{\land}}\al{54}{1}{ deleted \.{=} [ {\FALSE} \.{\mapsto} ( MaxKeys
 \.{-} 1 ) ]}
\fl{}
\fl{ Create ( key ,\, value ) \.{\defeq}}
\fl{ \.{\land}}\al{57}{1}{ key \.{\neq}\@w{deleted}}
 \fl{ \.{\land}}\al{58}{1}{ keys \.{'} \.{=} [ keys {\EXCEPT} {\bang} [ i ]
 \.{=} key ]}
 \fl{ \.{\land}}\al{59}{1}{ values \.{'} \.{=} [ values {\EXCEPT} {\bang} [ i
 ] \.{=} value ]}
 \fl{ \.{\land}}\al{60}{1}{ versions \.{'} \.{=} [ versions {\EXCEPT} {\bang}
 [ i ] \.{=} 1 ]}
 \fl{ \.{\land}}\al{61}{1}{ deleted \.{'} \.{=} [ deleted {\EXCEPT} {\bang} [
 i ] \.{=} {\FALSE} ]}
\fl{ \.{\land}}\al{62}{1}{ i \.{'} \.{=} ( i \.{+} 1 ) \.{\%} MaxKeys}
\fl{ \.{\land}}\al{63}{1}{ root \.{'} \.{=} Insert ( root ,\, key ,\, i )}
\fl{ \.{\land}}\al{64}{1}{ Next \.{=} Create ( key ,\, value )}
\fl{}
\fl{ Read ( key ) \.{\defeq}}
\fl{ \.{\land}}\al{67}{1}{ key \.{\neq}\@w{deleted}}
 \fl{ \.{\land}}\al{68}{1}{ EXISTS i \.{\in} 0 \.{\dotdot} MaxKeys \.{-} 1
 \.{:} key \.{=} keys [ i ]}
\fl{ \.{\land}}\al{69}{1}{ value \.{=} values [ i ]}
\fl{ \.{\land}}\al{70}{1}{ version \.{=} versions [ i ]}
\fl{ \.{\land}}\al{71}{1}{ Next \.{=} Read ( key )}
\fl{}
\fl{ Update ( key ,\, value ,\, version ) \.{\defeq}}
\fl{ \.{\land}}\al{74}{1}{ key \.{\neq}\@w{deleted}}
 \fl{ \.{\land}}\al{75}{1}{ EXISTS i \.{\in} 0 \.{\dotdot} MaxKeys \.{-} 1
 \.{:} key \.{=} keys [ i ]}
\fl{ \.{\land}}\al{76}{1}{ version \.{<} versions [ i ]}
\fl{ \.{\land}}\al{77}{1}{ deleted [ i ] \.{=} {\FALSE}}
\fl{ \.{\land}}\al{78}{1}{ keys \.{'} \.{=} keys}
 \fl{ \.{\land}}\al{79}{1}{ values \.{'} \.{=} [ values {\EXCEPT} {\bang} [ i
 ] \.{=} value ]}
 \fl{ \.{\land}}\al{80}{1}{ versions \.{'} \.{=} [ versions {\EXCEPT} {\bang}
 [ i ] \.{=} version \.{+} 1 ]}
\fl{ \.{\land}}\al{81}{1}{ deleted \.{'} \.{=} deleted}
\fl{ \.{\land}}\al{82}{1}{ root \.{'} \.{=} Update ( root ,\, key ,\, i )}
\fl{ \.{\land}}\al{83}{1}{ Next \.{=} Update ( key ,\, value ,\, version )}
\fl{}
\fl{ Delete ( key ,\, version ) \.{\defeq}}
\fl{ \.{\land}}\al{86}{1}{ key \.{\neq}\@w{deleted}}
 \fl{ \.{\land}}\al{87}{1}{ EXISTS i \.{\in} 0 \.{\dotdot} MaxKeys \.{-} 1
 \.{:} key \.{=} keys [ i ]}
\fl{ \.{\land}}\al{88}{1}{ version \.{<} versions [ i ]}
\fl{ \.{\land}}\al{89}{1}{ deleted [ i ] \.{=} {\FALSE}}
\fl{ \.{\land}}\al{90}{1}{ keys \.{'} \.{=} keys}
\fl{ \.{\land}}\al{91}{1}{ values \.{'} \.{=} values}
 \fl{ \.{\land}}\al{92}{1}{ versions \.{'} \.{=} [ versions {\EXCEPT} {\bang}
 [ i ] \.{=} version \.{+} 1 ]}
 \fl{ \.{\land}}\al{93}{1}{ deleted \.{'} \.{=} [ deleted {\EXCEPT} {\bang} [
 i ] \.{=} {\TRUE} ]}
\fl{ \.{\land}}\al{94}{1}{ root \.{'} \.{=} root}
\fl{ \.{\land}}\al{95}{1}{ Next \.{=} Delete ( key ,\, version )}
\fl{}
\fl{ Spec \.{\defeq}}
\fl{ \.{\land}}\al{98}{1}{ Init}
 \fl{ \.{\land}}\al{99}{1}{ {\Box} [ Next ]_{ {\langle} keys ,\, values ,\,
 versions ,\, deleted ,\, root {\rangle}}}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
