...
\fl{}\moduleLeftDash\cl{ {\MODULE} BPlusTree}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals}
\fl{}
\fl{}
\fl{}
\fl{ {\CONSTANTS}}
\fl{ Order ,\, KeyType ,\, Node ,\, LeafNode ,\, IndexNode}
\fl{}
\fl{ {\VARIABLES}}
\fl{ root}
\fl{}
 \fl{ NodeType ( node )}\al{11}{4}{ \.{\defeq}}\al{11}{5}{ node}\al{11}{6}{
 \.{\in}}\al{11}{7}{ LeafNode \.{\cup} IndexNode}
\fl{}
 \fl{ LeafNode ( node )}\al{13}{4}{ \.{\defeq}}\al{13}{5}{ node}\al{13}{6}{
 \.{\in}}\al{13}{7}{ LeafNode}
\fl{ IndexNode ( node ) \.{\defeq} node \.{\in} IndexNode}
\fl{}
\fl{ EmptyLeafNode ( node ) \.{\defeq}}
\fl{ \.{\land}}\al{17}{1}{ LeafNode ( node )}
\fl{ \.{\land}}\al{18}{1}{ node . keys \.{=} {\Box}}
\fl{ \.{\land}}\al{19}{1}{ node . values \.{=} {\Box}}
\fl{ \.{\land}}\al{20}{1}{ node . next \.{=} null}
\fl{}
\fl{ NonEmptyLeafNode ( node ) \.{\defeq}}
\fl{ \.{\land}}\al{23}{1}{ LeafNode ( node )}
\fl{ \.{\land}}\al{24}{1}{ node . keys \.{\neq} {\Box}}
\fl{ \.{\land}}\al{25}{1}{ node . values \.{\neq} {\Box}}
\fl{ \.{\land}}\al{26}{1}{ node . next \.{\neq} null}
\fl{}
\fl{ EmptyIndexNode ( node ) \.{\defeq}}
\fl{ \.{\land}}\al{29}{1}{ IndexNode ( node )}
\fl{ \.{\land}}\al{30}{1}{ node . keys \.{=} {\Box}}
\fl{ \.{\land}}\al{31}{1}{ node . children \.{=} {\Box}}
\fl{}
\fl{ NonEmptyIndexNode ( node ) \.{\defeq}}
\fl{ \.{\land}}\al{34}{1}{ IndexNode ( node )}
\fl{ \.{\land}}\al{35}{1}{ node . keys \.{\neq} {\Box}}
\fl{ \.{\land}}\al{36}{1}{ node . children \.{\neq} {\Box}}
\fl{}
\fl{ NodeInvariant ( node ) \.{\defeq}}
\fl{ \.{\land} LeafNode ( node ) \.{\implies}}
\fl{ ( node . keys . cardinality \.{=} node . values . cardinality )}
\fl{ \.{\land} IndexNode ( node ) \.{\implies}}
 \fl{ ( node . keys . cardinality \.{+} 1 \.{=} node . children . cardinality
 )}
\fl{}
\fl{ TreeInvariant \.{\defeq}}
\fl{ \.{\land} ( root \.{=} null ) \.{\implies}}
\fl{ ( TypeInvariant \.{\land} NodeType ( root ) )}
\fl{ \.{\land} ( root \.{\neq} null ) \.{\implies}}
\fl{ ( TypeInvariant \.{\land} NodeInvariant ( root ) \.{/}}
\fl{ ( \A\, child \.{\in} {\SUBSET} root . children \.{:} TreeInvariant ) )}
\fl{}
\fl{ Init \.{\defeq}}
\fl{ \.{\land} root \.{=} null}
\fl{}
\fl{ Insert ( node ,\, key ,\, value ) \.{\defeq}}
\fl{ \.{\land}}\al{55}{1}{ LeafNode ( node )}
\fl{ \.{\land}}\al{56}{1}{ key \.{\in} KeyType}
\fl{ \.{\land}}\al{57}{1}{ value}\al{57}{2}{ \.{\in} ObjectPath}
 \fl{ \.{\land}}\al{58}{1}{ node \.{'}}\al{58}{3}{ \.{=} Append ( node ,\, key
 ,\, value )}
 \fl{ \.{\land}}\al{59}{1}{ ( node \.{'} . keys . cardinality \.{>} Order )
 \.{\implies}}
\fl{ ( node \.{'} \.{=} Split ( node \.{'} ) )}
\fl{ \.{\land} root \.{'} \.{=} ( node \.{=} root ) \.{\implies} node \.{'}}
\fl{}
\fl{ Search ( node ,\, key ) \.{\defeq}}
\fl{ \.{\land}}\al{64}{1}{ LeafNode ( node )}
\fl{ \.{\land}}\al{65}{1}{ key \.{\in} KeyType}
 \fl{ \.{\land}}\al{66}{1}{ value \.{=} node . values [ node . keys . IndexOf
 ( key ) ]}
\fl{}
\fl{}
\fl{ SplitLeafNode ( node ,\, key ,\, value ) \.{\defeq}}
 \fl{ \.{\land}}\al{70}{1}{ node . keys \.{'} \.{=} [ node . keys {\EXCEPT}
 {\bang} [ i ] \.{=} key ]}
 \fl{ \.{\land}}\al{71}{1}{ node . values \.{'}}\al{71}{5}{ \.{=}}\al{71}{6}{
 [ node . values {\EXCEPT} {\bang} [ i ] \.{=} value ]}
 \fl{ \.{\land}}\al{72}{1}{ newNode . keys}\al{72}{4}{ \.{=}}\al{72}{5}{ [
 node . keys [ Order \.{-} 1 ] ]}
 \fl{ \.{\land}}\al{73}{1}{ newNode . values \.{=} [ node . values [ Order
 \.{-} 1 ] ]}
\fl{ \.{\land}}\al{74}{1}{ newNode . next \.{=} node . next}
 \fl{ \.{\land}}\al{75}{1}{ node . keys \.{=} node . keys [ 0 \.{\dotdot}
 Order \.{-} 2 ]}
 \fl{ \.{\land}}\al{76}{1}{ node . values \.{=} node . values [ 0 \.{\dotdot}
 Order \.{-} 2 ]}
\fl{ \.{\land}}\al{77}{1}{ node . next \.{=} newNode}
 \fl{ \.{\land}}\al{78}{1}{ newParent . keys \.{=} [ node . keys [ Order \.{-}
 2 ] ]}
\fl{ \.{\land}}\al{79}{1}{ newParent . children \.{=} [ node ,\, newNode ]}
\fl{ \.{\land}}\al{80}{1}{ newParent}
\fl{}
\fl{}
\fl{ Append ( node ,\, key ,\, value ) \.{\defeq}}
\fl{ \.{\land}}\al{84}{1}{ LeafNode ( node )}
\fl{ \.{\land}}\al{85}{1}{ key \.{\in} KeyType}
\fl{ \.{\land}}\al{86}{1}{ value \.{\in} ObjectPath}
\fl{ \.{\land}}\al{87}{1}{ i \.{=} node . keys . IndexOf ( key )}
\fl{ \.{\land}}\al{88}{1}{ ( i \.{>} 0 ) \.{\implies}}
 \fl{ ( node . keys \.{'} \.{=} [ node . keys [ 1 \.{\dotdot} i \.{-} 1 ] ,\,
 key ,\, node . keys [ i \.{+} 1 \.{\dotdot} \.{-} 1 ] ] )}
\fl{ \.{\land} ( i \.{=} 0 ) \.{\implies}}
\fl{ ( node . keys \.{'} \.{=} [ key ,\, node . keys ] )}
\fl{ \.{\land} ( i \.{=} \.{-} 1 ) \.{\implies}}
\fl{ ( node . keys \.{'} \.{=} node . keys )}
\fl{ \.{\land} i \.{=} node . values . IndexOf ( value}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
