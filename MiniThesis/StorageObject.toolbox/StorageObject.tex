...
\fl{}\moduleLeftDash\cl{ {\MODULE} StorageObject}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, FiniteSets ,\, Randomization%
\@y{%
 introduce \ensuremath{Integers} modules and
 \ensuremath{Naturals}*\ensuremath{\.{\,\backslash\,}
}}%
}
\fl{}
\fl{ {\CONSTANTS} Nodes ,\, Root ,\, MaxCardinality%
\@y{\@s{0}%
 we use \ensuremath{MaxCardinality} instead of
 Infinity*\ensuremath{\.{\,\backslash\,}
}}%
}
\fl{}
\fl{}
...
\fl{}
\fl{}
 \fl{ {\VARIABLE} object ,\, controlState ,\, subControlState ,\, key ,\, Ver
 ,\, Edges ,\, Path}
\fl{}
 \fl{ TypeOK \.{\defeq}}\al{45}{2}{ \.{\land}}\al{45}{3}{ controlState \.{\in}
 \{\@w{Start} ,\,\@w{middle} ,\,\@w{done} \}}
 \fl{ \.{\land}}\al{46}{1}{ subControlState \.{\in} \{\@w{Lf} ,\,\@w{Pt}
 ,\,\@w{Co} \}}
\fl{ \.{\land}}\al{47}{1}{ key \.{\in} [ Nodes \.{\rightarrow} Nodes ]}
\fl{ \.{\land}}\al{48}{1}{ Ver \.{\in} [ Nodes \.{\rightarrow} Nat ]}
\fl{}
\fl{ {\ASSUME}}\al{50}{1}{ \.{\land}}\al{50}{2}{ Root \.{\in} Nodes}
\fl{ \.{\land}}\al{51}{1}{ MaxCardinality}\al{51}{2}{ \.{\in} Nat}
 \fl{ \.{\land}}\al{52}{1}{ MaxCardinality}\al{52}{2}{ \.{\geq} Cardinality (
 Nodes )}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ Versions ( n ) \.{\defeq} \{ m \.{\in} Nodes \.{:} \{ m ,\, n \} \.{\in}
 Edges \}}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ vars \.{\defeq} {\langle} key ,\, Ver ,\, Edges {\rangle}%
\@y{\@s{0}%
 or child nodes instead \ensuremath{Childnodes} (how many child nodes is
 linked to current parent *\ensuremath{\.{\,\backslash\,}
}}%
}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ Init \.{\defeq}}\al{69}{2}{ \.{\land}}\al{69}{3}{ key}\al{69}{4}{
 \.{=}}\al{69}{5}{ [ n}\al{69}{7}{ \.{\in}}\al{69}{8}{ Nodes}\al{69}{9}{
 \.{\mapsto}}\al{69}{10}{ n ]}
 \fl{ \.{\land}}\al{70}{1}{ Ver}\al{70}{2}{ \.{=}}\al{70}{3}{ [ n}\al{70}{5}{
 \.{\in}}\al{70}{6}{ Nodes}\al{70}{7}{ \.{\mapsto}}\al{70}{8}{ {\IF} n \.{=}
 Root \.{\THEN} 0 \.{\ELSE} MaxCardinality ]}
 \fl{ \.{\land}}\al{71}{1}{ Edges \.{\in} \{ E}\al{71}{5}{ \.{\in} {\SUBSET} (
 {\SUBSET} Nodes ) \.{:} \A\, e \.{\in} E \.{:} Cardinality ( e ) \.{=} 2 \}}
\fl{ \.{\land}}\al{72}{1}{ controlState}\al{72}{2}{ \.{=}\@w{middle}}
\fl{ \.{\land}}\al{73}{1}{ subControlState \.{=}\@w{Pt}}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ Next \.{\defeq}}\al{100}{2}{ \E\, n \.{\in} Nodes \.{:}}
\fl{ \E\,}\al{101}{1}{ m \.{\in} Versions ( n ) \.{:}}
\fl{ \.{\land}}\al{102}{1}{ Ver [ m ] \.{<} 1 \.{+} Ver [ n ]}
 \fl{ \.{\land}}\al{103}{1}{ \E\,}\al{103}{2}{ d \.{\in} ( Ver [ m ] \.{+} 1 )
 \.{\dotdot} ( Ver [ n ] \.{-} 1 ) \.{:}}
 \fl{ \.{\land}}\al{104}{1}{ Ver \.{'} \.{=} [ Ver {\EXCEPT} {\bang} [ n ]
 \.{=} d ]}
 \fl{ \.{\land}}\al{105}{1}{ key \.{'} \.{=} [ key {\EXCEPT} {\bang} [ n ]
 \.{=} m ]}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ PostCondition \.{\defeq}}
\fl{ \A\, n \.{\in} Nodes \.{:}}
\fl{ \.{\lor}}\al{125}{1}{ \.{\land}}\al{125}{2}{ n \.{=} Root}
\fl{ \.{\land}}\al{126}{1}{ Ver [ n ]}\al{126}{5}{ \.{=}}\al{126}{6}{ 0}
\fl{ \.{\land}}\al{127}{1}{ key [ n ]}\al{127}{5}{ \.{=}}\al{127}{6}{ n}
 \fl{ \.{\lor}}\al{128}{1}{ \.{\land}}\al{128}{2}{ Ver [ n ]}\al{128}{6}{
 \.{=} MaxCardinality}
\fl{ \.{\land}}\al{129}{1}{ key [ n ]}\al{129}{5}{ \.{=} n}
 \fl{ \.{\land}}\al{130}{1}{ \A\, m \.{\in} Versions ( n ) \.{:} Ver [ m ]
 \.{=} MaxCardinality}
 \fl{ \.{\lor}}\al{131}{1}{ \.{\land}}\al{131}{2}{ Ver [ n ]}\al{131}{6}{
 \.{\in}}\al{131}{7}{ 1 \.{\dotdot} ( MaxCardinality \.{-} 1 )}
 \fl{ \.{\land}}\al{132}{1}{ key [ n ]}\al{132}{5}{ \.{\in}}\al{132}{6}{
 Versions ( n )}
 \fl{ \.{\land}}\al{133}{1}{ Ver [ n ]}\al{133}{5}{ \.{=} Ver [ key [ n ] ]
 \.{+} 1}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
 \fl{ Safety \.{\defeq} {\Box} ( ( {\lnot} {\ENABLED} Next ) \.{\implies}
 PostCondition )}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ Liveness \.{\defeq} {\Diamond} ( {\lnot} {\ENABLED} Next )}
\fl{}
\fl{}
\fl{}
\fl{}
